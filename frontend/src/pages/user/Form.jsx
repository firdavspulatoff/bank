...
function UserForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <input className="inpf" type="text" {...register("cityBirth")} placeholder="City Birth" />
      ...
      <input className="inpf" type="email" {...register("email")} placeholder="Email" />
      
      
      <input className="inpf" type="text" {...register("work")} placeholder="Work" />
      <input className="inpf" type="text" {...register("level")} placeholder="Level" /> 
      ...
      { <input className="inpf" type="text" {...register("income")} placeholder="Income" /> }
      { <label className="inpf">
        <Controller
          name="isMillitary"
          control={control}
      ...
      <button style={{backgroundColor:'black',padding:'8px'}} type="submit">Submit</button>
    </form>
  );
}
